     ...
     <main className="flex flex-col h-[60vh] w-[50vw] ">
        <section className="h-[50%] flex w-[50vw]">
            <div className="flex flex-col justify-center items-center w-[10vw]">
                ...
                <a className="w-[15vh] h-[8vh]" href="https://github.com/JanitzDePaz?tab=repositories" target="_blank"><img className="w-[15vh] h-[8vh]" src="windows/github.png" alt="logo de github" /></a>
            </div>
