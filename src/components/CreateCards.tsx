...
export default function CreateCards({name, description, image, imageAlt, icons}:cards){
    return(
        <article className="flex flex-col justify-around items-center w-[15vw] h-[35vh] bg-[white] border-[#3270ad] border-[1px] rounded-[16px] overflow-hidden m-[1%] hover:translate-y-[-5px] duration-[0.3s]">
            ...
            <div className="h-[19vh] w-[15vw] flex flex-col justify-between ">
                ...
                <p className="h-[45%] text-justify mx-[10%] overflow-y-auto">{description}</p>
